public class Test {
	...
	public static void main(String[] args) {
		try {
			...
			// String urlStr = null;
			// String requestData="{\"tracking_number\":\"A000644586305\"}";
			...
			// String	urlStr ="?page=1&limit=100&created_at_min=0&created_at_max=0&update_time_min=0&update_time_max=0&order_created_time_min=0&order_created_time_max=0&numbers=A000644586305&orders=&lang=cn";
			// String requestData=null;
			// String result = new Tracker().orderOnlineByJson(requestData,urlStr,"get");
			// System.out.println("result======="+result);

			// 5 Get tracking results of a single tracking.
			// String	urlStr ="/zjs-express/A000644586305/en";
			// String requestData=null;
			...
			// String	urlStr ="/zjs-express/A000644586305";
			...
			// String	urlStr =null;
			// String requestData="{\"tracking_number\": \"A000644586305\",\"carrier_code\":\"zjs-express\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}";
			// String result = new Tracker().orderOnlineByJson(requestData,urlStr,"realtime");
			// System.out.println("result======="+result);

			// 10 Modify courier code
			// String	urlStr =null;
			// String requestData="{\"tracking_number\": \"A000644586305\",\"carrier_code\":\"zjs-express\",\"update_carrier_code\":\"china-ems\"}";
			...
			// String	urlStr =null;
			// String requestData= "[{\"tracking_number\":\"A000644586305\",\"carrier_code\":\"zjs-express\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]";
			...
			// String	urlStr =null;
			// String requestData= "[{\"carrier_code\":\"zjs-express\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]";
